/* ====== DATASET ====== */
/* Usa dog1..dog4.jpg già presenti per evitare 404 in demo */
const dogs = [
...
function renderGrid(list){
  ...
  list.forEach(d=>{
    ...
    el.innerHTML = `
      ...
      <div class="body">
        <div class="name">${d.name}, ${d.age}${d.verified ? '<span class="badge-verify" style="font-size:16px;margin-left:6px;color:#1d4ed8">🐾</span>' : ''}</div>
  ...
  sheetEl.innerHTML = `
    ...
    <div class="dinfo">
      <h2 style="margin:0 0 6px;display:flex;align-items:center;flex-wrap:wrap;gap:6px">
        <span>${d.name}, ${d.age}</span>${d.verified ? '<span class="badge-verify" style="font-size:16px;margin-left:8px;color:#1d4ed8">🐾</span>' : ''}
      </h2>
