 ...
 function fmtKm(n){
  ...
  setActiveView("profile");
    ...
    profileContent.innerHTML = `
      ...
      <div class="pp-head">
        <h2 class="pp-name">${d.name} ${d.verified?'✅':''} <span style="font-size:0.9rem;color:var(--muted);font-weight:normal;margin-left:0.5rem;">• ${Math.floor(Math.random() * 490) + 10} followers</span></h2>
        <div class="pp-badges">
